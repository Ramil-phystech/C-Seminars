...
path_to_vectorizer = "models/vectorizers/multi_RandomForestClassifier(data_9)_vectorizer.joblib"
path_to_model = "models/multi_RandomForestClassifier(data_9).sav"

stop_words = set(stopwords.words('russian'))
vectorizer = joblib.load(path_to_vectorizer)

p = ['Anekdot', 'Bolls_and_Cows', 'Goodbye', 'Hello', 'Time', 'Weather']
